                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!--<a href="#" class="table-action-btn"><i class="md md-edit"></i></a>-->
                                        <a href="#custom-edit-modal-{{ $location->id }}" class="table-action-btn" data-animation="fadein"
                                            data-plugin="custommodal" data-overlaySpeed="200" data-overlayColor="#36404a">
                                             <i class="md md-edit"></i>
                                         </a>
                                         <div id="custom-edit-modal-{{ $location->id }}" class="modal-demo">
                                             <button type="button" class="close" onclick="Custombox.close();">
                                                 <span>&times;</span><span class="sr-only">Fermer</span>
                                             </button>
                                             <h4 class="custom-modal-title">Enregistrer un véhicule</h4>
                                             <div class="custom-modal-text text-left">
                                                 <form method="POST" action="/edit/{{ $location->id }}/location">
                                                     {{ method_field('PATCH') }}
                                                     @include('location.form', ['btnSubmit' => 'Modifier', 'location' => $location])
                                                 </form>
                                             </div>
                                         </div>
                                        <!--<a href="#" class="table-action-btn"><i class="md md-close"></i></a>-->
                                        <a href="#custom-delete-modal-{{ $location->id }}" class="table-action-btn" data-animation="fadein"
                                            data-plugin="custommodal" data-overlaySpeed="200" data-overlayColor="#36404a">
                                             <i class="md md-close"></i>
                                         </a>
                                         <div id="custom-delete-modal-{{ $location->id }}" class="modal-demo">
                                             <button type="button" class="close" onclick="Custombox.close();">
                                                 <span>&times;</span><span class="sr-only">Fermer</span>
                                             </button>
                                             <h4 class="custom-modal-title">Supprimer un location</h4>
                                             <div class="custom-modal-text text-left">
                                                 <div class="modal-body">
                                                     Voulez-vous supprimer la location {{ $location->vehicule->modele->marque->name }} ?
                                                 </div>
